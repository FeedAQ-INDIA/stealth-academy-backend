...
// };
const saveWritingSubmission = async (userId, promptId, submissionText) => {
    try {
        console.log('Service received:', { userId, promptId, submissionText }); // Debug log
        ...
        if (!submissionText || typeof submissionText !== 'string') {
            throw new Error("submissionText is required and must be a string");
        }
